...
template <typename Type_> struct EigenProps
{
	...
	static constexpr bool
	    ...
	    vector = Type::IsVectorAtCompileTime, // At least one dimension has
	                                          // fixed size 1
	...
	static constexpr auto descriptor =
	    ...
	    // 'typing.Annotated[numpy.typing.NDArray[numpy.float64], "[3,2]"]' and
	    // an error message that you *gave* a numpy.ndarray of the right type
	    // and dimensions.
...
struct type_caster<Type, enable_if_t<is_eigen_sparse<Type>::value>>
{
	...
	bool load(handle src, bool)
	{
		...
		value = EigenMapSparseMatrix<
		    Scalar, Type::Flags &(Eigen::RowMajor | Eigen::ColMajor),
		    StorageIndex>(shape[0].cast<Index>(), shape[1].cast<Index>(),
		                  std::move(nnz), outerIndices.mutable_data(),
