...
#define PYBIND11_EMBEDDED_MODULE(name, variable)                               \
	...
	::pybind11::detail::embedded_module PYBIND11_CONCAT(                       \
	    pybind11_module_, name)(PYBIND11_TOSTRING(name),                       \
                                                ...
                                                bool add_program_dir_to_path)
{
	...
	PySys_SetArgvEx(argc, pysys_argv,
...
inline void finalize_interpreter()
{
	...
	auto *&local_internals_ptr_ptr =
	    detail::get_internals_pp<detail::local_internals>();
	{
		dict state_dict = detail::get_python_state_dict();
		internals_ptr_ptr = detail::get_internals_pp_from_capsule_in_state_dict<
		    detail::internals>(state_dict, PYBIND11_INTERNALS_ID);
		local_internals_ptr_ptr =
		    detail::get_internals_pp_from_capsule_in_state_dict<
		        detail::local_internals>(state_dict,
		                                 detail::get_local_internals_id());
	}
