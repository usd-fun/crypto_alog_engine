...
{
	return plus_impl(a, b, make_index_sequence<N1>(),
...
io_name(char const (&text1)[N1], char const (&text2)[N2], char const (&)[N3],
        char const (&)[N4])
{
...
io_name(char const (&)[N1], char const (&)[N2], char const (&text3)[N3],
        char const (&text4)[N4])
{
